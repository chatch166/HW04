...
# connect to reddit 
reddit = praw.Reddit('armybot2')

# select a "home" submission in the /r/BotTown subreddit to post to,
# and put the url below
submission_url = 'https://old.reddit.com/r/BotTown2/comments/r30mrw/stephen_sondheim_master_craftsman_who_reinvented/'
...
while True:
    ...
    for comment in all_comments:
        if str(comment.author) != 'BOThersomebOT3':
    ...
    if has_not_commented:
        ...
        for comment in not_my_comments:
            ...
            if 'BOThersomebOT3' not in commentauthors:
